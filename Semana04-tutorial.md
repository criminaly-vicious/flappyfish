...
Depois de testar seu jogo, publique o projeto em seu **Repositório Individual** e disponibilize, no card da **Adalove**, **dois links obrigatórios**:

- o **link para o código do seu Projeto Individual**;
- o **link para a versão jogável do Projeto Individual** *(seu(sua) professor(a) de programação indicará onde e como publicar)*.

No **card da Adalove**, inclua também:

- o **título do seu jogo**;
- uma **descrição narrativa ou contextual**  
  *(exemplo: “um alienígena precisa coletar moedas em um cenário espacial”)*;
- a **descrição dos controles do jogo**  
  *(exemplo: “use as setas do teclado para mover o alienígena”)*.

Você pode copiar a estrutura abaixo e preenchê-la com as informações do seu projeto:
...
4. Link do código (Repositório Individual): (insira aqui o link do código do seu Projeto Individual)

5. Link da versão jogável: (insira aqui o link da versão jogável do seu Projeto Individual)
...
- Publicou o projeto (com pastas organizadas) no Repositório Individual: até 1 ponto
- Apresentou título e explicou contexto e controle do jogo (na resposta do card da Adalove): até 1 ponto
- Desafio! Publicou uma versão jogável de seu Projeto Individual (não esqueça de enviar o link no card da Adalove!): até 1 ponto